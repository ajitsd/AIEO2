...
- It runs on your computer. We say it runs **locally**. To be fancy, we could say it runs **on-prem** (on your local premises).
- It lets you:
    - Revert to older versions of `code`
    - Create branches during `code` development
...
- It uses Git, and has extra features like
    - Storing repos for you on their computers. We say they are hosted **remotely**.
